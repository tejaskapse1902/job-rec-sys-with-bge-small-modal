...
def _normalize_job_doc(doc: dict) -> JobResponse:
    ...
    return JobResponse(
        ...
        external_provider=_optional_text(doc.get("external_provider")),
        source_label=_optional_text(doc.get("source_label")),
        attribution_required=_coerce_bool(doc.get("attribution_required", False), False),
        attribution_text=_optional_text(doc.get("attribution_text")),
        attribution_url=_normalize_job_link(doc.get("attribution_url")),
        publisher=_optional_text(doc.get("publisher")),
